...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-3 rounded-b-[1.75rem] border-t border-white/[0.08] bg-white/[0.03] p-5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >

  ...
  return (
    <div className="relative grid min-h-[240px] w-full place-items-center sm:min-h-[320px]">
      <div className="relative grid place-items-center">
        <div
          className="pointer-events-none absolute inset-0 rounded-full opacity-90 blur-2xl transition-all duration-500"
          style={{
        ...
        <div
          ...
          className="relative flex size-56 items-center justify-center rounded-full p-3 shadow-[0_0_38px_rgba(0,0,0,0.26)] sm:size-72 sm:p-4"
          style={{
            background: `conic-gradient(${stage.color} ${safeProgress}%, rgba(255,255,255,0.08) 0)`,
          }}
        >
          <div className="flex size-full flex-col items-center justify-center rounded-full border border-white/[0.08] bg-[rgba(14,15,20,0.96)] text-center shadow-[0_16px_40px_rgba(0,0,0,0.32),inset_0_1px_0_rgba(255,255,255,0.04)]">
